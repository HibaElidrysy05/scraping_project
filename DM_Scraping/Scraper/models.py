...
class Product(models.Model):
    ...
    titre_complet = models.CharField(max_length=500, null=True, blank=True)

    prix = models.FloatField(null=True, blank=True)

    devise = models.CharField(max_length=20, null=True, blank=True)

    plateforme = models.CharField(max_length=100, null=True, blank=True)

    note_vendeur = models.FloatField(null=True, blank=True)

    nombre_avis = models.IntegerField(null=True, blank=True)

    etat = models.CharField(max_length=50, null=True, blank=True)

    type_vendeur = models.CharField(max_length=50, null=True, blank=True)
    ...
    id_recherche = models.CharField(max_length=100, null=True, blank=True)
